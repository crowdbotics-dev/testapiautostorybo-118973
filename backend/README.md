...
## Project Structure
    ...
    ├── testapiautostorybo_118973  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_118973`
...
2. Clone this repo and `cd testapiautostorybo_118973`
